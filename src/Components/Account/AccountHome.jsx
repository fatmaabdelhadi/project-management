    ...
    <div>
      ...
      <div class="filtersRow">
        ...
        <div className="filterP">
          <button class="btnDropFilterP">
            {" "}
            Filter By Priority <img src={dropDownImg} alt="dropdown" />
          </button>
          <form>
            <input type="checkbox" />
            <label>Urgent</label>
        ...
        <div className="filterS">
          <button class="btnDropFilterS">
            Filter By Status <img src={dropDownImg} alt="dropdown" />
          </button>
          <form>
            <input type="checkbox" />
            <label>Late</label>
